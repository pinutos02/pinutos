          ...
          {assets.map((asset) => (
            ...
            >
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-stone-700 line-clamp-1">{asset.subtitle || "No subtitle"}</p>
              </div>
              ...
              <div className="p-6 md:p-8 space-y-8 overflow-y-auto custom-scrollbar flex-grow">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                  <div className="space-y-3">
                    <label className="text-[10px] font-black uppercase tracking-widest text-stone-700 ml-1">Content Category</label>
                  ...
                  <div className="space-y-3">
                    <label className="text-[10px] font-black uppercase tracking-widest text-stone-700 ml-1">Showcase Title</label>
                    <input
                      type="text"
                ...
                <div className="space-y-3">
                  <label className="text-[10px] font-black uppercase tracking-widest text-stone-700 ml-1">The Story (Subtitle)</label>
                  <textarea
                ...
                {editingAsset.type === 'video' ? (
                  <div className="space-y-3">
                    <label className="text-[10px] font-black uppercase tracking-widest text-stone-700 ml-1">Video Source (Embed URL)</label>
                    <div className="relative">
                      <input
                        type="text"
                  ...
                  <div className="space-y-3">
                    <label className="text-[10px] font-black uppercase tracking-widest text-stone-700 ml-1">Visual Asset</label>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 pt-4">
                   <div className="space-y-3">
                      <label className="text-[10px] font-black uppercase tracking-widest text-stone-700 ml-1">Action Link (Optional)</label>
                      <input
                        type="text"
                    ...
                    <div className="flex items-end pb-1">
                       <label className="flex items-center gap-4 cursor-pointer group w-full bg-stone-50/50 p-4 border border-brand-sepia/20 hover:bg-white hover:border-brand-sepia/50 transition-all rounded-sm">
                          ...
                          <div>
                            ...
                            <span className="text-[8px] text-stone-600 uppercase tracking-widest">Publish to live site</span>
                          </div>
                       </label>
                    </div>
                </div>
